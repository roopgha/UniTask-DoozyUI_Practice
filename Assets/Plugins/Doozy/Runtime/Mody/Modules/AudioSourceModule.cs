...
namespace Doozy.Runtime.Mody.Modules
{
	...
	public class AudioSourceModule : ModyModule
	{
		...
		public const string DEFAULT_MODULE_NAME = "AudioSource";
		...
		public AudioSourceModule() : this(DEFAULT_MODULE_NAME) { }
		...
		public AudioSourceModule(AudioSource audioSource) : this(DEFAULT_MODULE_NAME, audioSource) { }

		/// <summary> Construct an AudioSource module with the given module name and AudioSource reference </summary>
		/// <param name="moduleName"> Module name </param>
		/// <param name="audioSource"> AudioSource reference </param>
		public AudioSourceModule(string moduleName, AudioSource audioSource) : this(moduleName.IsNullOrEmpty() ? DEFAULT_MODULE_NAME : moduleName)
		{
			Source = audioSource;
		}
