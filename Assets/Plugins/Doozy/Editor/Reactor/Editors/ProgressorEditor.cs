        ...
        private void InitializeEditor()
        {
            ...
            root.schedule.Execute(() =>
            {
                ...
                bool HasCallbacks() =>
                    ...
                    castedTarget.OnValueReset.GetPersistentEventCount() > 0 |
                    castedTarget.OnValueReachedFromValue.GetPersistentEventCount() > 0 |
                    castedTarget.OnValueReachedToValue.GetPersistentEventCount() > 0;
        ...
        private void InitializeCallbacks()
        {
            ...
            callbacksAnimatedContainer.SetOnShowCallback(() =>
            {
                callbacksAnimatedContainer
                    ...
                    .AddContent(DesignUtils.spaceBlock2X)
                    .AddContent(FluidField.Get().AddFieldContent(DesignUtils.UnityEventField("On Value Reset", propertyOnValueReset)))
                    .AddContent(DesignUtils.spaceBlock2X)
                    .AddContent(FluidField.Get().AddFieldContent(DesignUtils.UnityEventField("On Value Reached From Value", propertyOnValueReachedFromValue)))
                    .AddContent(DesignUtils.spaceBlock2X)
                    .AddContent(FluidField.Get().AddFieldContent(DesignUtils.UnityEventField("On Value Reached To Value", propertyOnValueReachedToValue)))
                    .Bind(serializedObject);
            });
        }
